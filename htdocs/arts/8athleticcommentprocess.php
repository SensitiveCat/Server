<?php
  ...
  $sql = "INSERT INTO athleticcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './8athleticview?id=' . $proid;

  $sql = "INSERT INTO athleticestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
