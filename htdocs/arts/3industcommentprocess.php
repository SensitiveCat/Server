<?php
  ...
  $sql = "INSERT INTO industcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './3industview?id=' . $proid;

  $sql = "INSERT INTO industestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
