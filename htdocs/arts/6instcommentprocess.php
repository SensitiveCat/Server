<?php
  ...
  $sql = "INSERT INTO instcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './6instview?id=' . $proid;

  $sql = "INSERT INTO instestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
