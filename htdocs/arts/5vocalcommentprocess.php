<?php
  ...
  $sql = "INSERT INTO vocalcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './5vocalview?id=' . $proid;

  $sql = "INSERT INTO vocalestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
