<?php
  ...
  $sql = "INSERT INTO compocomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './7compoview?id=' . $proid;

  $sql = "INSERT INTO compoestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
