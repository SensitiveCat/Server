<?php
  ...
  $sql = "INSERT INTO visualcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './2visualview?id=' . $proid;

  $sql = "INSERT INTO visualestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
