<?php
  ...
  $sql = "INSERT INTO actcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './10actview?id=' . $proid;

  $sql = "INSERT INTO actestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
