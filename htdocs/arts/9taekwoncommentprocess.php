<?php
  ...
  $sql = "INSERT INTO taekwoncomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './9taekwonview?id=' . $proid;

  $sql = "INSERT INTO taekwonestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
