<?php
  ...
  $sql = "INSERT INTO dentcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './6dentview?id=' . $proid;

  $sql = "INSERT INTO dentestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
