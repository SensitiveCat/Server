<?php
  ...
  $sql = "INSERT INTO biomcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './10biomview?id=' . $proid;

  $sql = "INSERT INTO biomestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
