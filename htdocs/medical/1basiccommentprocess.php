<?php
  ...
  $sql = "INSERT INTO basicmcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './1basicview?id=' . $proid;

  $sql = "INSERT INTO basicmestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
