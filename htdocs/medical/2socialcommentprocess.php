<?php
  ...
  $sql = "INSERT INTO socialcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './2socialview?id=' . $proid;

  $sql = "INSERT INTO socialestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
