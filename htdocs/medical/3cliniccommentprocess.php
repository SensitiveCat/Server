<?php
  ...
  $sql = "INSERT INTO cliniccomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './3clinicview?id=' . $proid;

  $sql = "INSERT INTO clinicestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
