...
$id = $_GET['id'];
$sql = "SELECT * FROM phre WHERE id=$id";
    ...
    <article class="contents">
      <div class="jumbotron">
          ...
          <tr>
            ...
            <td class="tr" width="50%" style="padding-top: 20px;"><div id="level" style="width:80%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></td>
          </tr>
          <tr>
            <td width="20%">강의 분위기</td>
            <td width="50%"><div id="mood" style="width:80%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></td>
          </tr>
          <tr>
            <td width="20%">강의 질</td>
            <td width="50%"><div id="qual" style="width:80%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></td>
          </tr>
          <tr>
            <td width="20%">과제량</td>
            <td width="50%"><div id="quan" style="width:80%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></td>
          </tr>
          <tr>
            <td width="20%">과제 난이도</td>
            <td width="50%"><div id="reportlv" style="width:80%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></td>
          </tr>
          <tr>
            <td width="20%">시험 난이도</td>
            <td width="50%"><div id="testlv" style="width:80%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></td>
          </tr>
          <tr>
            <td width="20%">학점 부여도</td>
            <td width="50%"><div id="scorelv" style="width:80%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></td>
          </tr>
          <tr>
            <td width="20%">교재 구매 추천도</td>
            <td width="50%"><div id="book" style="width:80%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></td>
          </tr>
          <tr>
            <td width="20%" class="bl" style="padding-bottom: 20px;">인성</td>
            <td width="50%" class="br" style="padding-bottom: 20px;"><div id="insung" style="width:80%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></td>
          </tr>
          <?php
          $total = 5;
          ...
          if($avglevel == null) {
            ...
            document.getElementById("level").innerHTML="<div style=\"width:80%;background-color:#1996E4;border-phtrus:10px;\"> 평가 없음 </div>";
            </script>';
          } else {
              echo '<script language="javascript">
              document.getElementById("level").innerHTML="<div style=\"width:'.$levelpercent.';background-color:#FFC71A;border-phtrus:10px;\">'.$avglevel.'점</div>";
              </script>';
            }
          ...
          if($avgmood == null) {
            echo '<script language="javascript">
            document.getElementById("mood").innerHTML="<div style=\"width:80%;background-color:#1996E4;border-phtrus:10px;\"> 평가 없음 </div>";
            </script>';
          } else {
              echo '<script language="javascript">
              document.getElementById("mood").innerHTML="<div style=\"width:'.$moodpercent.';background-color:#FFC71A;border-phtrus:10px;\">'.$avgmood.'점</div>";
              </script>';
            }
          ...
          if($avgqual == null) {
            echo '<script language="javascript">
            document.getElementById("qual").innerHTML="<div style=\"width:80%;background-color:#1996E4;border-phtrus:10px;\"> 평가 없음 </div>";
            </script>';
          } else {
              echo '<script language="javascript">
              document.getElementById("qual").innerHTML="<div style=\"width:'.$qualpercent.';background-color:#FFC71A;border-phtrus:10px;\">'.$avgqual.'점</div>";
              </script>';
            }
          ...
          if($avgquan == null) {
            echo '<script language="javascript">
            document.getElementById("quan").innerHTML="<div style=\"width:80%;background-color:#1996E4;border-phtrus:10px;\"> 평가 없음 </div>";
            </script>';
          } else {
              echo '<script language="javascript">
              document.getElementById("quan").innerHTML="<div style=\"width:'.$quanpercent.';background-color:#FFC71A;border-phtrus:10px;\">'.$avgquan.'점</div>";
              </script>';
            }
            ...
            if($avgreportlv == null) {
              echo '<script language="javascript">
              document.getElementById("reportlv").innerHTML="<div style=\"width:80%;background-color:#1996E4;border-phtrus:10px;\"> 평가 없음 </div>";
              </script>';
            } else {
            echo '<script language="javascript">
            document.getElementById("reportlv").innerHTML="<div style=\"width:'.$reportlvpercent.';background-color:#FFC71A;border-phtrus:10px;\">'.$avgreportlv.'점</div>";
            </script>';
          }
            ...
            if ($avgtestlv == null) {
              echo '<script language="javascript">
              document.getElementById("testlv").innerHTML="<div style=\"width:80%;background-color:#1996E4;border-phtrus:10px;\"> 평가 없음 </div>";
              </script>';
            } else {
              echo '<script language="javascript">
              document.getElementById("testlv").innerHTML="<div style=\"width:'.$testlvpercent.';background-color:#FFC71A;border-phtrus:10px;\">'.$avgtestlv.'점</div>";
              </script>';
            }
            ...
            if($avgscorelv == null) {
              echo '<script language="javascript">
              document.getElementById("scorelv").innerHTML="<div style=\"width:80%;background-color:#1996E4;border-phtrus:10px;\"> 평가 없음 </div>";
              </script>';
            } else {
            echo '<script language="javascript">
            document.getElementById("scorelv").innerHTML="<div style=\"width:'.$scorelvpercent.';background-color:#FFC71A;border-phtrus:10px;\">'.$avgscorelv.'점</div>";
            </script>';
          }
            ...
            if($avgbook == null) {
              echo '<script language="javascript">
              document.getElementById("book").innerHTML="<div style=\"width:80%;background-color:#1996E4;border-phtrus:10px;\"> 평가 없음 </div>";
              </script>';
            } else {
            echo '<script language="javascript">
            document.getElementById("book").innerHTML="<div style=\"width:'.$bookpercent.';background-color:#FFC71A;border-phtrus:10px;\">'.$avgbook.'점</div>";
            </script>';
          }
            ...
            if($avginsung == null) {
              echo '<script language="javascript">
              document.getElementById("insung").innerHTML="<div style=\"width:80%;background-color:#1996E4;border-phtrus:10px;\"> 평가 없음 </div>";
              </script>';
            } else {
            echo '<script language="javascript">
            document.getElementById("insung").innerHTML="<div style=\"width:'.$insungpercent.';background-color:#FFC71A;border-phtrus:10px;\">'.$avginsung.'점</div>";
            </script>';
          }
          ...
          require('../config/config2.php');
          $conn = db_init($config2["host"], $config2["duser"], $config2["dpw"], $config2["dname"]);
          $sql = "SELECT ROUND(AVG(score), 2) FROM phrecomment WHERE proid=$id";
          $result = mysqli_query($conn, $sql);
          $row = mysqli_fetch_assoc($result);
          $avgscore = $row['ROUND(AVG(score), 2)'];
          echo '<div id="progress" style="width:50%;background-color:#1996E4;border-phtrus:10px;display: inline-block;"></div>';
          if($avgscore == null) {
          ...
          $percent = (( $avgscore / $total ) * 100)."%";
              echo '<script language="javascript">
              document.getElementById("progress").innerHTML="<div style=\"width:'.$percent.';background-color:#FFC71A;border-phtrus:10px;\">'.$percent.'</div>";
              </script>';
            }
           ?>
        ...
        <div class="jumbotron">
          ...
          <?php
          $sql = "SELECT * FROM phrecomment WHERE proid='.$id' ORDER BY liked DESC, created DESC LIMIT 3";
          $result = mysqli_query($conn, $sql);
          if($result->num_rows >= 1) {
            ...
            <tr>
              ...
              <tr><td class="like">
                <?php
                if(!isset($_SESSION['is_login'])){
                  ?><input type="submit" name="name" value="Like : <?php echo $row['liked']?>" class="likebtn btn-primary" style="border-phtrus: 30px;border:0px solid black;"><?php
                }
                else {
                    if(isset($_SESSION['id'])){?>
                          <form class="" action="11phrelikeProcess.php" method="post">
                          <input type="hidden" name="nick" value="<?php echo $_SESSION['id']?>">
                          <input type="hidden" name="liked" value="<?php echo $row['nick']?>">
                          <input type="hidden" name="id" value="<?php echo $row['id']?>">
                          <input type="submit" name="name" value="Like : <?php echo $row['liked']?>" class="likebtn btn-primary" style="border-phtrus: 30px;border:0px solid black;">
                        </form><td class="comdel"><?php
                        if($_SESSION['id'] == $row['nick']) {?>
                          <form class="" action="11phrecommentdelete.php" method="post">
                          <input type="hidden" name="nick" value="<?php echo $_SESSION['id']?>">
                          <input type="hidden" name="liked" value="<?php echo $row['nick']?>">
                          <input type="hidden" name="id" value="<?php echo $row['id']?>">
                          <input type="submit" name="name" value="댓글삭제" class="delbtn btn-danger" style="font-size:0.9em;border-phtrus: 30px;border:0px solid black;">
                          </form></td><?php
                        }
                    }
                  }
        ...
        <div class="jumbotron">
          <h2 class="text-center">COMMENTS</h2>
            ...
            $sql = "SELECT count(*) as cnt FROM phrecomment WHERE proid=$id ORDER BY created DESC";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            ...
            if($page != 1) {
              $paging .= '<td class="page page_start"><a class="text-center btn btn-default" href="./11phreview?id='.$id.'&page=1">처음</a></td>';
            }
            if($currentSection != 1) {
              $paging .='<td class="page page_prev"><a class="text-center btn btn-primary" href="./11phreview?id='.$id.'&page='.$prevPage.'">이전</a></td>';
            }

            for($i = $firstPage; $i <= $lastPage; $i++) {
              if($i == $page) {
                $paging .='<td class="page current"><a class="text-center btn btn-info" href="./11phreview?id='.$id.'page='.$i.'">'.$i.'</a></td>';
              }
              else {
                $paging .='<td class="page"><a class="text-center btn btn-primary" href="./11phreview?id='.$id.'&page='.$i.'">'.$i.'</a></td>';
              }
            }

            if($page != $allPage) {
              $paging .='<td class="page page_end"><a class="text-center btn btn-default" href="./11phreview?id='.$id.'&page='.$allPage.'">끝</a></td>';
            }
            $paging .='</tr></table></div>';
            ...
            $sql = "SELECT * FROM phrecomment WHERE proid=$id ORDER BY created $sqlLimit";
            $result = mysqli_query($conn, $sql);
          }
          else {
            $sql = "SELECT * FROM phrecomment WHERE proid=$id ORDER BY created";
            $result = mysqli_query($conn, $sql);
          }
                    ...
                    ?><input type="submit" name="name" value="Like : <?php echo $row['liked']?>" class="likebtn btn-primary" style="border-phtrus: 30px;border:0px solid black;"><?php
                      ...
                      if(isset($_SESSION['id'])){?>
                          ...
                          if($_SESSION['id'] == $row['nick']) {?>
                            ...
                            <input type="hidden" name="id" value="<?php echo $row['id']?>">
                            <input type="submit" name="name" value="댓글삭제" class="delbtn btn-danger" style="font-size:0.9em;border-phtrus: 30px;border:0px solid black;">
                          </form><form class="" action="11phrecommentupdate.php?page=<?php echo $page?>&id=<?php echo $id ?>" method="post">
                                <input type="hidden" name="nick" value="<?php echo $_SESSION['id']?>">
                                <input type="hidden" name="liked" value="<?php echo $row['nick']?>">
                                <input type="hidden" name="id" value="<?php echo $row['id']?>">
        ...
        <div class="jumbotron">
          ...
          <?php
            if(!isset($_SESSION['is_login'])) {
              ...
              ?>
            <form class="" action="11phrecommentprocess?id=<?php echo $id?>" method="post">
        ...
        <button onclick="location.href='../medical/11phre'" class="btn btn-default btn-lg btn-block text-center">목록으로 돌아가기</button>
      <p id="footer">
