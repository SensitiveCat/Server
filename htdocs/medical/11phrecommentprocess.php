<?php
  ...
  $sql = "INSERT INTO phrecomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './11phreview?id=' . $proid;

  $sql = "INSERT INTO phreestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
