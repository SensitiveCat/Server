<?php
  ...
  $sql = "INSERT INTO emercomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './7emerview?id=' . $proid;

  $sql = "INSERT INTO emerestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
