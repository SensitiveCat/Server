<?php
  ...
  $sql = "INSERT INTO radicomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './8radiview?id=' . $proid;

  $sql = "INSERT INTO radiestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
