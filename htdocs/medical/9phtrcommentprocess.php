<?php
  ...
  $sql = "INSERT INTO phtrcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './9phtrview?id=' . $proid;

  $sql = "INSERT INTO phtrestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
