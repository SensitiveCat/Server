<?php
  ...
  $sql = "INSERT INTO nursecomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './5nurseview?id=' . $proid;

  $sql = "INSERT INTO nurseestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
