<?php
  ...
  $sql = "INSERT INTO 1hancomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './1hanview?id=' . $proid;

  $sql = "INSERT INTO 1hanestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
