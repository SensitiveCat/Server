<?php
  ...
  $sql = "INSERT INTO freecomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './freeview?id=' . $proid;

  $sql = "INSERT INTO freeestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
