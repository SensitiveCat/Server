<?php
  ...
  $sql = "INSERT INTO nanophcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './5nanophview?id=' . $proid;

  $sql = "INSERT INTO nanophestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
