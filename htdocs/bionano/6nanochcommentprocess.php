<?php
  ...
  $sql = "INSERT INTO nanochcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './6nanochview?id=' . $proid;

  $sql = "INSERT INTO nanochestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
