<?php
  ...
  $sql = "INSERT INTO biocomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './3bioview?id=' . $proid;

  $sql = "INSERT INTO bioestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
