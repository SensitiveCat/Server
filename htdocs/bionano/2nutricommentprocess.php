<?php
  ...
  $sql = "INSERT INTO nutricomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './2nutriview?id=' . $proid;

  $sql = "INSERT INTO nutriestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
