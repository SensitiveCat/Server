<?php
  ...
  $sql = "INSERT INTO lifecomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './4lifeview?id=' . $proid;

  $sql = "INSERT INTO lifeestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
