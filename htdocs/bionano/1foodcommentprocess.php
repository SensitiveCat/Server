<?php
  ...
  $sql = "INSERT INTO foodcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './1foodview?id=' . $proid;

  $sql = "INSERT INTO foodestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
