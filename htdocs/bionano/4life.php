...
if($page != 1) {
  $paging .= '<a class="text-center btn btn-default" href="./4life?page=1">처음</a>&nbsp;';
}
if($currentSection != 1) {
  $paging .='<a class="text-center btn btn-primary" href="./4life?page='.$prevPage.'">이전</a>&nbsp;';
}

for($i = $firstPage; $i <= $lastPage; $i++) {
  if($i == $page) {
    $paging .='<a class="text-center btn btn-info" href="./life?page='.$i.'">'.$i.'</a>&nbsp;';
  }
  else {
    $paging .='<a class="text-center btn btn-primary" href="./4life?page='.$i.'">'.$i.'</a>&nbsp;';
  }
}

if($page != $allPage) {
  $paging .='<a class="text-center btn btn-default" href="./4life?page='.$allPage.'">끝</a>&nbsp;';
}
$paging .='</div>';
