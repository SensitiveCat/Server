    ...
    <article class="contents">
      <div class="jumbotron">
        ...
        <div class="jumbotron">
          ...
          <?php
          $sql = 'SELECT * FROM nanophcomment ORDER BY liked DESC, created DESC LIMIT 3';
          $result = mysqli_query($conn, $sql);
        ...
        <button onclick="location.href='../nanophnano/5nanoph'" class="btn btn-default btn-lg btn-block text-center">목록으로 돌아가기</button>
      <p id="footer">
