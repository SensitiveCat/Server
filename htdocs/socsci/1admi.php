...
$sql = 'SELECT * FROM admi ORDER BY id'.$sqlLimit;
$result = mysqli_query($conn, $sql);
 ?>
<!DOCTYPE html>
<html>
          ...
          <div class="jumbotron">
              <table class="professortable">
                <tr class="proheader">
                  ...
                  <td width="20%">이름</td>
                  <td width="25%">전공</td>
                  <td width="15%" class="tr br" rowspan="2" width="15%"><a id="viewesti" href="../socsci/1admiview?page=<?php echo $page ?>&id=<?php echo $row['id']?>" class="btn btn-primary">평가 보기</a></td>
                </tr>
                <tr>
