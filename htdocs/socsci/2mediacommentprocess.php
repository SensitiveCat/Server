<?php
  ...
  $sql = "INSERT INTO mediacomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './2mediaview?id=' . $proid;

  $sql = "INSERT INTO mediaestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
