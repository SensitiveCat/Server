<?php
  ...
  $sql = "INSERT INTO kidseducomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './8kidseduview?id=' . $proid;

  $sql = "INSERT INTO kidseduestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
