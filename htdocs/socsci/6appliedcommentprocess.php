<?php
  ...
  $sql = "INSERT INTO appliedcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './6appliedview?id=' . $proid;

  $sql = "INSERT INTO appliedestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
