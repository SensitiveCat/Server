<?php
  ...
  $sql = "INSERT INTO welfarecomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './7welfareview?id=' . $proid;

  $sql = "INSERT INTO welfareestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
