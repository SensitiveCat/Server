<?php
  ...
  $sql = "INSERT INTO globalcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './4globalview?id=' . $proid;

  $sql = "INSERT INTO globalestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
