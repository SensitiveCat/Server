<?php
  ...
  $sql = "INSERT INTO officercomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './9officerview?id=' . $proid;

  $sql = "INSERT INTO officerestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
