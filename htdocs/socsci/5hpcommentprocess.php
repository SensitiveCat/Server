<?php
  ...
  $sql = "INSERT INTO hpcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './5hpview?id=' . $proid;

  $sql = "INSERT INTO hpestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
