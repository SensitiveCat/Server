...
if($_GET['squery']!='') {
  ...
  $sql = "SELECT count(*) as cnt FROM eu '.$where.' ORDER BY id DESC";
...
$sql = 'SELECT * FROM eu '.$where.' ORDER BY id'.$sqlLimit;
$result = mysqli_query($conn, $sql);
 ?>
<!DOCTYPE html>
<html>
   ...
   <p>
    ...
    <article class="contents"><div class="jumbotron">
      ...
      ?>
                  ...
                  <td width="30%"><h4><a id="viewesti" href="../inmundae/4euview?page=<?php echo $page ?>&id=<?php echo $row['id']?>" class="btn btn-primary">평가 보기</a>
                    <?php
                      $countsql = 'SELECT count(*) as cnt FROM euestimate WHERE proid='.$row['id'];
        ...
        <div class="paging">
          ...
          ?>
          <form class="text-center form-inline" action="4eu" method="get">
