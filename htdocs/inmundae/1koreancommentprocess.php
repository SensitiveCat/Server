<?php
  ...
  $sql = "INSERT INTO koreancomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './1koreanview?id=' . $proid;

  $sql = "INSERT INTO koreanestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
