<?php
  ...
  $sql = "INSERT INTO eastcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './3eastlangview?id=' . $proid;

  $sql = "INSERT INTO eastestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
