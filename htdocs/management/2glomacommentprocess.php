<?php
  ...
  $sql = "INSERT INTO glomacomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './2glomaview?id=' . $proid;

  $sql = "INSERT INTO glomaestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
