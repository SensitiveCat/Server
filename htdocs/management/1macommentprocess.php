<?php
  ...
  $sql = "INSERT INTO macomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './1maview?id=' . $proid;

  $sql = "INSERT INTO maestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
