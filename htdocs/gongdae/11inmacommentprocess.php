<?php
  ...
  $sql = "INSERT INTO inmacomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './11inmaview?id=' . $proid;

  $sql = "INSERT INTO inmaestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
