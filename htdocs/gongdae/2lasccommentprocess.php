<?php
  ...
  $sql = "INSERT INTO la_sccomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './2lascview?id=' . $proid;

  $sql = "INSERT INTO la_scestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
