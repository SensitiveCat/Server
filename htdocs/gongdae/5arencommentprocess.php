<?php
  ...
  $sql = "INSERT INTO arencomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './5arenview?id=' . $proid;

  $sql = "INSERT INTO arenestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
