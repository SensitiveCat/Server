<?php
  ...
  $sql = "INSERT INTO emmacomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './7emmaview?id=' . $proid;

  $sql = "INSERT INTO emmaestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
