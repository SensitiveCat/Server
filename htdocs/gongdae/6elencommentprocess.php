<?php
  ...
  $sql = "INSERT INTO elencomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './6elenview?id=' . $proid;

  $sql = "INSERT INTO elenestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
