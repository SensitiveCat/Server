<?php
  ...
  $sql = "INSERT INTO citycomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './1cityview?id=' . $proid;

  $sql = "INSERT INTO cityestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
