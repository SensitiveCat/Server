    ...
    <div class="jumbotron">
      ...
      <?php
        if(!isset($_SESSION['is_login'])) {
          ...
          ?>
        <form class="" action="9maencommentupdateprocess?page=<?php echo $page ?>&id=<?php echo $proid?>" method="post">
      ...
      <a class="btn btn-default btn-lg btn-block text-center" href="./9maenview?page=<?php echo $page?>&id=<?php echo $proid ?>">돌아가기</a>
