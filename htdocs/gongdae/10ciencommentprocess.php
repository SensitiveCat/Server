<?php
  ...
  $sql = "INSERT INTO ciencomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './10cienview?id=' . $proid;

  $sql = "INSERT INTO cienestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
