<?php
  ...
  $sql = "INSERT INTO maencomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './9maenview?id=' . $proid;

  $sql = "INSERT INTO maenestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
