<?php
  ...
  $sql = "INSERT INTO comment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replaceURL = './computerview?id=' . $proid;

  $sql = "INSERT INTO estimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
