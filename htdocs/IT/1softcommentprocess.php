<?php
  ...
  $sql = "INSERT INTO softcomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './1softview?id=' . $proid;

  $sql = "INSERT INTO softestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
