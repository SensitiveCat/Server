<?php
  ...
  $sql = "INSERT INTO energycomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './4energyview?id=' . $proid;

  $sql = "INSERT INTO energyestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
