<?php
  ...
  $sql = "INSERT INTO mathinfocomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './5mathinfoview?id=' . $proid;

  $sql = "INSERT INTO mathinfoestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
