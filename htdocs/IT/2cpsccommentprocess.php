<?php
  ...
  $sql = "INSERT INTO cpsccomment (proid, nick, score, comment) VALUES ('".$proid."','".$nick."','".$score."','".$comment."')";
  $result = mysqli_query($conn, $sql);
  $replacadmiRL = './2cpscview?id=' . $proid;

  $sql = "INSERT INTO cpscestimate (level, mood, qual, quan, reportlv, testlv, scorelv, book, insung, proid)
